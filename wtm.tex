    ...
    % subsection pojęcia (end)
        ...
        % subsubsection relacje (end)
            ...
            \begin{enumerate}
                ...
                oznacza zbiór ilorazowy ($ X / R \subset X $).
                    \begin{enumerate}
                        ...
                        Zatem z przechodniości R mamy \framebox[1.1\width]{$ x R y $}.\\

                        Ponieważ $ [x]_R \neq [y]_R $, więc (z lematu) \framebox[1.1\width]{$\neg(x R y)$}.\\
            ...
            \begin{enumerate}
                ...
                $ X/R $, tzn. $ \mathbb{Z} = (\mathbb{N} \times \mathbb{N} ) / R $. \framebox[1.1\width]{Zbiór liczb całkowitych.}\\
